...
export const freelancerProfileExample: FreelancerProfile = {
  ...
  coverImage: "/images/coverImages/cover1.png",
  rating: 4.9,
  totalReviews: 127,
  ...
  portfolio: [
    {
      ...
      description:
        "Série de robes élégantes pour événements spéciaux, inspirées des motifs traditionnels congolais.",
    ...
    },
    {
      ...
      description:
        "Costumes sur mesure pour professionnels, alliant élégance et confort.",
      image: "/api/placeholder/400/300",
    ...
    },
    {
      ...
      description:
        "Créations uniques pour mariages, mélangeant tradition et modernité.",
      image: "/api/placeholder/400/300",
      category: "Mariage",
    ...
    },
    {
      ...
      description:
        "Vêtements contemporains utilisant des tissus wax authentiques.",
      image: "/api/placeholder/400/300",
  ...
  reviews: [
    {
      ...
      rating: 5,
      comment:
        "Travail exceptionnel ! Marie a créé une robe de soirée magnifique qui correspondait parfaitement à mes attentes. Très professionnelle et à l'écoute.",
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "Excellent travail sur mes costumes d'affaires. Qualité irréprochable et livraison dans les délais. Je recommande vivement !",
    ...
    },
    {
      ...
      rating: 4,
      comment:
        "Très satisfaite de ma robe de mariage. Marie a su capturer ma vision et la transformer en réalité. Merci !",
  ...
  workExperience: [
    {
      ...
      description:
        "Création de vêtements sur mesure pour clientèle privée et entreprises.",
      current: true,
    },
    {
      id: 2,
      ...
      duration: "2019 - 2022",
      description:
        "Conception et réalisation de collections pour boutique haut de gamme.",
      current: false,
    },
    {
      id: 3,
      ...
      duration: "2016 - 2019",
      description:
        "Apprentissage des techniques traditionnelles et modernes de couture.",
      current: false,
    },
  ],
